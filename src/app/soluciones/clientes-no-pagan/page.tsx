...
export default function ClientesNoPaganPage() {
  return (
    <>
      {/* ================= SEO ================= */}
      <Head>
        <title>
          Clientes que no pagan en Colombia | Cómo recuperar deudas
          efectivamente
        </title>

        <meta
          name="description"
          content="¿Tienes clientes que no pagan? Recupera tu dinero en Colombia con estrategias de cobro profesional, negociación y acciones legales."
        />

        <meta
          name="keywords"
          content="clientes que no pagan, recuperar deudas Colombia, cobro de cartera Bogotá, deudores morosos, cobrar clientes"
        />
      </Head>
      ...
      <main className={styles.pageWrapper}>
          ...
          <div className={styles.heroContainer}>
            ...
            >
              ...
              <p className={styles.description}>
                ...
                obligaciones, necesitas una estrategia profesional. Te ayudamos
                a recuperar tu dinero en Colombia mediante negociación, cobro
        ...
        <section className={styles.container}>
          ...
          <p className={styles.text}>
            ...
            problemas financieros en empresas y negocios en Colombia. No se
            trata solo de una deuda, sino del impacto directo en tu flujo de
            caja, operación y crecimiento.
          </p>
        ...
        <section id="solucion" className={styles.container}>
          ...
          <p className={styles.text}>
            ...
            comunicación y respaldo legal. No se trata de insistir, sino de
        ...
        <section className={styles.container}>
          ...
          <div className={styles.highlightBox}>
            Cada tipo de cliente requiere una estrategia diferente para lograr
            el pago.
          </div>
        </section>
