...
export default function MejorarFlujoCajaPage() {
  return (
    <>
      {/* ================= SEO ================= */}
      <Head>
        <title>
          Mejorar flujo de caja en Colombia | Aumenta liquidez y control
          financiero
        </title>

        <meta
          name="description"
          content="Aprende cómo mejorar el flujo de caja de tu empresa en Colombia con estrategias de cobro, control de cartera y optimización financiera."
        />

        <meta
          name="keywords"
          content="mejorar flujo de caja, flujo de caja Colombia, liquidez empresa, gestión financiera, reducir cartera"
        />
      </Head>
      ...
      <main className={styles.pageWrapper}>
          ...
          <div className={styles.heroContainer}>
            ...
            >
              ...
              <p className={styles.description}>
                ...
                ayudamos a optimizar ingresos, reducir retrasos en pagos y
                mejorar la liquidez mediante estrategias efectivas de gestión de
                cartera y recaudo.
              </p>
        ...
        <section className={styles.container}>
          ...
          <div className={styles.warningBox}>
            ⚠ Tener ventas no garantiza liquidez: lo importante es cuándo
            recibes el dinero.
          </div>
        </section>
        ...
        <section className={styles.container}>
          ...
          <p className={styles.text}>
            ...
            limitar el crecimiento y aumentar el riesgo financiero de tu
            empresa.
          </p>
