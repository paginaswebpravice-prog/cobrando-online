...
export default function RecuperarCarteraPage() {
  return (
    <>
      <script
      ...
      <main className={styles.pageWrapper}>
          ...
          <div className={styles.heroContainer}>
            ...
            >
              ...
              <p className={styles.description}>
                En <strong>Cobrando Online</strong> ayudamos a empresas,
                clínicas y personas a recuperar deudas en Colombia mediante
                estrategias de cobro prejurídico, negociación y procesos
                judiciales. Mejoramos tu flujo de caja y reducimos el riesgo
                financiero.
              </p>
        ...
        <section className={styles.container}>
          ...
          <p className={styles.text}>
            ...
            empresa o persona logra recuperar dinero adeudado por clientes, EPS
            o terceros. En Colombia, especialmente en ciudades como Bogotá, la
            mora en pagos es uno de los principales problemas financieros para
            empresas y sector salud.
          </p>

          <div className={styles.highlightBox}>
            ✔ Recuperar cartera a tiempo mejora el flujo de caja, evita pérdidas
            y fortalece la estabilidad financiera.
          </div>
        </section>
        ...
        <section className={styles.container}>
          ...
          <p className={styles.text}>
            Trabajamos diferentes tipos de cartera vencida adaptando la
            estrategia a cada caso.
          </p>
        ...
        <section id="proceso" className={styles.container}>
          ...
          <div className={styles.highlightBox}>
            ✔ Más del 70% de las deudas pueden recuperarse sin necesidad de
            llegar a un proceso judicial cuando se aplican estrategias
            correctas.
          </div>
        </section>
        ...
        <section className={styles.container}>
          ...
          <div className={styles.infoGrid}>
            ...
            <div>
              ...
              <p>
                No siempre. Muchas deudas se recuperan sin proceso judicial.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="contacto" className={styles.container}>
          <div className={styles.cta}>
            <h2 className={styles.ctaTitle}>
              Empieza hoy a recuperar tu dinero
            </h2>
