...
export default function IndicadoresCartera() {
  const baseUrl =
    "https://www.cobrandoonline.com/blog/indicadores-de-cartera-vencida";

  const schemaData = {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    headline: "Indicadores de cartera vencida que toda empresa debe conocer",
    description:
