...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${baseUrl}/blog/clientes-que-no-pagan-que-hacer-legalmente`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/blog/como-cobrar-factura-vencida-sin-perder-cliente`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/blog/recuperacion-cartera-pymes-guia-colombia`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/blog/mensajes-whatsapp-cobrar-clientes`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/blog/como-recuperar-cartera-mas-360-dias`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/blog/recuperacion-cartera-clinicas-ips`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/blog/como-reducir-cartera-vencida-empresa`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/blog/mejores-estrategias-cobranza-2026`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
