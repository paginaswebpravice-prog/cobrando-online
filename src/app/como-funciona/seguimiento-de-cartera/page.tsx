...
export default function SeguimientoCarteraPage() {
  return (
    <>
      {/* ================= SEO ================= */}
      <Head>
        <title>
          Seguimiento de cartera en Colombia | Control y trazabilidad en tiempo
          real
        </title>

        <meta
          name="description"
          content="Seguimiento de cartera en Colombia con acceso en línea, control total y visibilidad en cada etapa del proceso de cobro. Mejora tu recaudo."
        />

        <meta
          name="keywords"
          content="seguimiento de cartera Colombia, control de cartera, gestión de cobros, trazabilidad cartera, recuperar cartera seguimiento"
        />
      </Head>
      ...
      <main className={styles.pageWrapper}>
          ...
          <div className={styles.heroContainer}>
            ...
            >
              <span className={styles.badge}>
                Gestión de cartera en Colombia
              </span>
        ...
        <section className={styles.container}>
          ...
          <div className={styles.warningBox}>
            ⚠ Si no tienes control sobre tu cartera, no puedes mejorar tu
            recaudo.
          </div>
        </section>
        ...
        <section className={styles.container}>
          ...
          <p className={styles.text}>
            Nuestro enfoque se basa en brindar información clara y accesible
            para que siempre sepas qué está pasando con tu cartera y cómo avanza
            cada proceso de cobro.
          </p>
