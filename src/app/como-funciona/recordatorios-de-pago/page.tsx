...
export default function RecordatoriosAutomaticosPage() {
  return (
    <>
      {/* ================= SEO ================= */}
      <Head>
        ...
        <meta
          name="description"
          content="Implementa recordatorios automáticos de pago y reduce la cartera vencida. Automatiza el cobro y mejora tu flujo de caja en Colombia."
        />

        <meta
          name="keywords"
          content="recordatorios de pago automáticos, automatización de cobro, cartera vencida Colombia, gestión de cartera automática"
        />
      </Head>
      ...
      <main className={styles.pageWrapper}>
          ...
          <div className={styles.heroContainer}>
            ...
            >
              ...
              <h1 className={styles.title}>
                Recordatorios automáticos de pago para reducir la cartera
                vencida
              </h1>
        ...
        <section className={styles.container}>
          ...
          <div className={styles.warningBox}>
            ⚠ Depender de procesos manuales aumenta el riesgo de cartera
            vencida.
          </div>
        </section>
